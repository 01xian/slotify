<div id="navBarContainer">
	<nav class="navBar">
		...
		<div class="group">
			<div class="navItem">
				<span  role='link' tabindex='0' onclick='openPage("search.png")' class="navItemLink">
				Search  <!-- role='link'(告訴人這是link) tabindex='0'(按tab順序)都是給殘障人士用的 --> 
		...
		<div class="group">
			...
			<div class="navItem">
				<span  role="link" tabindex="0" onclick="openPage('profile.php')"> Reece Kenny </span>
			</div>
		</div>
	</nav>
